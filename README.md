...
Актуальный шаг (2026-09-05): [диагностика полезной вариативности внутри малой
группы](docs/SMALL_GROUP_NEXT_STEP_2026-09-05.md). После аудита noise-renderer v1
не рекомендуется для новых экспериментов. Его исходники и результаты сохранены.
Следующий пакет проверяет вклад ранней/поздней частей натуральной пары и общего
уровня. Он не использует старый noise-renderer или его численную дистанцию.
